...
def _get_live_job_search_prompt() -> str:
    ...
    return (
        ...
        "   • IMPORTANT: Retrieved results contain job data with field 'Jobs External Apply URL'\n"
        "4) FOR JOB SEARCH: Extract detailed job information from search results including external apply URLs\n"
        "   • CRITICAL: Look for 'Jobs External Apply URL:' or 'Jobs External Apply URL' in the retrieved text\n"
        "   • The retrieved content will have a line like: 'Jobs External Apply URL: https://...'\n"
        "   • Extract the COMPLETE URL that appears after 'Jobs External Apply URL:' - copy it EXACTLY\n"
        "   • DO NOT modify, shorten, or generate new URLs - use the EXACT URL from the retrieved text\n"
        "   • If you see 'Jobs External Apply URL: https://careers.company.com/apply/12345' then use 'https://careers.company.com/apply/12345'\n"
        "   • ONLY if 'Jobs External Apply URL' field is missing or empty in retrieved text, then construct: https://www.{company}.com/careers\n"
        "   • Map the extracted URL directly to 'external_apply_url' field in your JSON response\n"\n"
        ...
        "    \"external_apply_url\": \"EXACT_URL_from_Jobs_External_Apply_URL_column\"\n"
        "  }\n"
        "]\n\n"
        "EXAMPLE - If retrieved text contains:\n"
        "  'Job Title: Software Engineer\n"
        "   Company: Microsoft\n"
        "   Jobs External Apply URL: https://careers.microsoft.com/apply/12345'\n"
        "Then your JSON MUST have:\n"
        "  \"external_apply_url\": \"https://careers.microsoft.com/apply/12345\"\n"
        "NOT: \"external_apply_url\": \"https://www.microsoft.com/careers\"\n"
        "NOT: \"external_apply_url\": \"undefined\"\n\n"
        "PARSING INSTRUCTION:\n"
        "• Search retrieved text for pattern: 'Jobs External Apply URL:' followed by URL\n"
        "• Extract everything after 'Jobs External Apply URL:' until next line\n"
        "• Use this EXACT value for external_apply_url in JSON\n\n"
        ...
        "        "• CRITICAL: The knowledge base contains a 'Jobs External Apply URL' column with actual application links\n"
        "• MUST extract the EXACT URL from 'Jobs External Apply URL' column - do not modify or generate new URLs\n"
        "• Copy the 'Jobs External Apply URL' value exactly as it appears in the knowledge base\n"
        "• ONLY construct a careers page URL if 'Jobs External Apply URL' is completely empty/missing\n"
        "• Priority: Use actual 'Jobs External Apply URL' > Generate careers page URL\n"\n"
...
def _get_batch_job_search_prompt() -> str:
    ...
    return (
        ...
        "       \"remote\": \"yes/no\",\n"
        "       \"experience\": \"experience_level\",\n"
        "       \"external_apply_url\": \"value_from_Jobs_External_Apply_URL_column\"\n"
        "     }\n"
        "   ]\n"
