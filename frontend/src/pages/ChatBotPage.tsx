...
const ChatBotPage: React.FC = () => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (isJobQuery(currentInput)) {
                const botMessage: Message = {
                    id: Date.now() + 1,
                    text: "I found some great job opportunities for you! Let me show you personalized recommendations.",
                    isUser: false,
                    timestamp: new Date()
                };
                ...
                // Navigate to job recommendations page after a short delay
                setTimeout(() => {
                    navigate('/job-recommendations', { state: { query: currentInput } });
                }, 1500);
                return;
            }
